...
#define mkatype(t,l) ((struct methodtable *) (ptr_int)(((l) << METHOD_FLAG_BITS)|(t)))
...
#define obj_monitor(handlep) ((ptr_int) handlep)
...
#define DeRef(env, ref) \
    ((signed long)(ref) > 0 ? \
         JNIEnvGetLocalRefs(env)->elements[(signed long)(ref) - 1].content \
       : ((ref) ? \
              globalRefTable.elements[-((signed long)(ref)) - 1].content \
            : 0))

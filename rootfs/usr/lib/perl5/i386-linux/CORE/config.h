 ...
 */
#define ARCHLIB "/usr/lib/perl5/i386-linux"		/**/
#define ARCHLIB_EXP "/usr/lib/perl5/i386-linux"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/lib/perl5/site_perl/i386-linux"		/**/
#define SITEARCH_EXP "/usr/lib/perl5/site_perl/i386-linux"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITELIB "/usr/lib/perl5/site_perl"		/**/
#define SITELIB_EXP "/usr/lib/perl5/site_perl"		/**/

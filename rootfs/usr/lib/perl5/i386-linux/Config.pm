...
## Package name      : perl5
## Source directory  : .
## Configuration time: Mon Apr  5 23:23:10 CDT 1999
## Configured by     : root
## Target system     : linux zap 2.2.5 #20 mon mar 29 19:36:54 cst 1999 i686 unknown 
#
...
dlsrc='dl_dlopen.xs'
dynamic_ext='B DB_File Data/Dumper Fcntl GDBM_File IO IPC/SysV NDBM_File ODBM_File Opcode POSIX SDBM_File Socket attrs re'
extensions='B DB_File Data/Dumper Fcntl GDBM_File IO IPC/SysV NDBM_File ODBM_File Opcode POSIX SDBM_File Socket attrs re Errno'
...
apiversion='5.005'
ar='ar'
archlib='/usr/lib/perl5/i386-linux'
archobjs=''
awk='awk'
baserev='5.0'
bash=''
...
cccdlflags='-fpic'
ccdlflags='-rdynamic'
ccsymbols='__ELF__=1 __GNUC_MINOR__=7 __GNUC__=2 __linux=1 cpu=i386 machine=i386 system=posix system=unix'
cf_by='root'
cf_email='root@zap.slackware.com'
cf_time='Mon Apr  5 23:23:10 CDT 1999'
chgrp=''
chmod=''
chown=''
clocktype='clock_t'
...
cpp='cpp'
cpp_stuff='42'
cppccsymbols='__i386=1 __i386__=1 __i486__=1 __linux__=1 __unix=1 __unix__=1 i386=1 linux=1 unix=1'
cpplast='-'
cppminus='-'
cpprun='gcc -E'
cppstdin='gcc -E'
...
less='less'
lib_ext='.a'
libc='/lib/libc.so.5.4.46'
libperl='libperl.a'
libswanted='sfio socket inet nsl nm ndbm gdbm dbm db malloc dl dld ld sun m c cposix posix ndir dir crypt ucb BSD PW x'
line='line'
lint=''
lkflags=''
ln='ln'
...
mydomain='.slackware.com'
myhostname='zap'
myuname='linux zap 2.2.5 #20 mon mar 29 19:36:54 cst 1999 i686 unknown '
n='-n'
netdb_hlen_type='int'
...
signal_t='void'
sitearch='/usr/lib/perl5/site_perl/i386-linux'

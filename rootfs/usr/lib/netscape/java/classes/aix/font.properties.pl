# src/unix/sun/sun/awt/motif/font.properties.pl, a112, a112, a112-19970718 97/07/01
#
#  Copyright (c) 1994-1996 by Sun Microsystems Inc
#  Copyright (c) 1997 by IBM Corporation
#
# Polish AWT Font Properties for AIX
#
...
fontset.serif.plain=\
-monotype-times new roman-medium-r-normal--*-%d-*-*-p-*-iso8859-2

fontset.serif.italic=\
-monotype-times new roman-medium-i-normal--*-%d-*-*-p-*-iso8859-2

fontset.serif.bold=\
-monotype-times new roman-bold-r-normal--*-%d-*-*-p-*-iso8859-2

fontset.sansserif.italic=\
-linotype-helvetica-medium-i-normal--*-%d-*-*-p-*-iso8859-2
 
fontset.sansserif.bold=\
-linotype-helvetica-bold-r-normal--*-%d-*-*-p-*-iso8859-2
 
fontset.sansserif.plain=\
-linotype-helvetica-medium-r-normal--*-%d-*-*-p-*-iso8859-2

fontset.monospaced.italic=\
-urw-courier-medium-i-normal--*-%d-*-*-m-*-iso8859-2
 
fontset.monospaced.bold=\
-urw-courier-bold-r-normal--*-%d-*-*-m-*-iso8859-2
 
fontset.monospaced.plain=\
-urw-courier-medium-r-normal--*-%d-*-*-m-*-iso8859-2
 
fontset.dialog.italic=\
-ibm-block-medium-i-normal--*-%d-*-*-c-*-iso8859-2

fontset.dialog.bold=\
-ibm-block-bold-r-normal--*-%d-*-*-c-*-iso8859-2 

fontset.dialog.plain=\
-ibm-block-medium-r-normal--*-%d-*-*-c-*-iso8859-2

...
/* $Id: MKterm.h.awk.in,v 1.15 1996/11/16 21:36:42 tom Exp $ */
...
extern char * const *_nc_boolnames(void);
extern char * const *_nc_boolcodes(void);
extern char * const *_nc_boolfnames(void);
extern char * const *_nc_numnames(void);
extern char * const *_nc_numcodes(void);
extern char * const *_nc_numfnames(void);
extern char * const *_nc_strnames(void);
extern char * const *_nc_strcodes(void);
extern char * const *_nc_strfnames(void);
